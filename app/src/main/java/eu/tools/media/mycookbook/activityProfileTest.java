...
public class activityProfileTest extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_profile_test, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.listRecette) {
            Intent intent = new Intent(activityProfileTest.this, activityProfile.class);
